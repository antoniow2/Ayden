...
const Profile = () => {
  ...
  useEffect(() => {
    ...
    Axios.get(
      "https://systembreakerswhat-a8b3a7e03d39.herokuapp.com/users/profile",
      {
  ...
  const fetchSavedIngredients = useCallback(async () => {
    try {
      const response = await Axios.get(
        "https://systembreakerswhat-a8b3a7e03d39.herokuapp.com/users/saved_ingredients",
        {
          withCredentials: true,
          headers: {
  ...
  const handleSaveIngredients = async () => {
    try {
      ...
      const response = await Axios.post(
        "https://systembreakerswhat-a8b3a7e03d39.herokuapp.com/users/profile_ingredient_list",
        {
  ...
  const handleDeleteIngredient = async (ingredientName) => {
    try {
      const response = await Axios.delete(
        "https://systembreakerswhat-a8b3a7e03d39.herokuapp.com/users/delete_ingredient",
        {
          withCredentials: true,
          headers: {
            Authorization: `Bearer ${Cookies.get("userToken")}`,
